...
//
//  1. Follow the steps listed here:"http://developer.razerzone.com/nabu/guides/develop-ios/" to set up your Xcode project
//
//	2. Create an URI scheme callback in the "URL Types" section from your Info.plist (this is the way your app communicates with the Nabu Utility)
//  
//  3. Just copy and paste the following code in the AppDelegate.m file (this way you override the following method to handle the way you app opens URLs)
...
//      }
//
//  4. Import the NabuManager.h in your ViewController
//		#import "NabuManager.h"
//
//	5. You now have all the Nabu's features at your fingertips with just one class. NabuManager is a singleton, only one instance
//	lives at a time, so you can access it's public properties and methods this way:
...
//
//  6. For every method's description please check it's documentation by pressing the "alt" key and clicking on that method, or just check the header
//
//
//
//      WARNING: SOME METHODS COULD TAKE MORE TIME TO BE EXECUTED DUE TO THE INTERACTION WITH THE NABU UTILITY, IT IS RECOMMANDED TO CALL THE METHODS
