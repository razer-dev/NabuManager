...
//
//	6. You now have all the Nabu's features at your fingertips with just one class. NabuManager is a singleton, only one instance
...
//
//
//      WARNING: SOME METHODS COULD TAKE MORE TIME TO BE EXECUTED DUE TO THE INTERACTION WITH THE NABU UTILITY, IT IS RECOMMENDED TO CALL THE METHODS
